...
public class OrderServiceApplication {
	...
	public CommandLineRunner test(OrderRepository repository) {
		return (args) -> {
			...
			Order order1 = new Order("3e8126fa-f603-4e2c-b7d4-29b311e2b44f", items, "shippingAddress", "billingAddress", "paymentMethod", "orderStatus", "orderDate", "deliveryDate", "deliveryCompany", "trackingNumber", "deliveryStatus", "deliveryAddress", 100);
			Order order2 = new Order("3e8126fa-f603-4e2c-b7d4-29b311e2b44f", items, "shippingAddress", "billingAddress", "paymentMethod", "orderStatus", "orderDate", "deliveryDate", "deliveryCompany", "trackingNumber", "deliveryStatus", "deliveryAddress", 200);
			Order order3 = new Order("3e8126fa-f603-4e2c-b7d4-29b311e2b44f", items, "shippingAddress", "billingAddress", "paymentMethod", "orderStatus", "orderDate", "deliveryDate", "deliveryCompany", "trackingNumber", "deliveryStatus", "deliveryAddress", 300);
